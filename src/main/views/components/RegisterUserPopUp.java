...
public class RegisterUserPopUp extends UserPopUps implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        AddNewUserController.addUserToDatabase(name.getTextArea().getText(),lastname.getTextArea().getText(),email.getTextArea().getText(),password.getTextArea().getText());
        name.getTextArea().setText(null);
        lastname.getTextArea().setText(null);
        email.getTextArea().setText(null);
        password.getTextArea().setText(null);
        name.requestFocus();
    }
}
